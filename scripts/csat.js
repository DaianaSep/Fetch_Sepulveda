...
setTimeout(() => {
    ...
    swalWithBootstrapButtons.fire({
        ...
        html: `<h5 style="margin-bottom:20px; color:orange">Puntúa de 1 a 5, donde 1 es insatisfecho y 5 es muy satisfecho</h5>
        <form>
            ...
            <textarea type="text" style="width:300px; height:100px; margin-bottom:15px; size:200; padding:10px"> </textarea>
