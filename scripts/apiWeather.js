...
const arrayTipsFrio = ["Mantén y refuerza tus hábitos de higiene. Lava tus manos para evitar el contagio de virus que causan los resfríos y la gripe. Además, recuerda cubrirte la boca con el brazo al momento de estornudar o toser para evitar la propagación de los gérmenes.",
    "Evita cambios bruscos de temperatura. La temperatura de tu vivienda debe estar en torno a los 22º C y es aconsejable que ventiles periódicamente los ambientes.",
    ...
    setTimeout(() => {
        if (main.temp < 18) {//Tips para clima frío
            ...
            Swal.fire({
                ...
                <a href="https://www.facebook.com/" target="_blank"></a><img id="logo" src="Images/gorjeo.png" class="card-img-sm" alt="..."></a>
                <a href="https://www.facebook.com/" target="_blank"></a><img id="logo" src="Images/instagram2.png" class="card-img-sm" alt="..."></a>`,
                imageWidth: 250,
                imageHeight: 200,
                customClass: {
